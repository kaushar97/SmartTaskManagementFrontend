        ...
        <div className="space-y-6 px-6 py-6 sm:px-8">
            ...
            <div>
                ...
                <input
                    ...
                    {...register("title")}
                    className={`mt-2 block w-full rounded-lg border bg-white px-4 py-2.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-100 ${
                        errors.title
            ...
            <div>
                ...
                <textarea
                    ...
                    className={`mt-2 block w-full resize-y rounded-lg border bg-white px-4 py-3 text-sm leading-6 text-slate-900 outline-none transition placeholder:text-slate-400 focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-100 ${
                        errors.description
                            ? "border-red-300 focus:border-red-500 focus:ring-red-100"
                            : "border-slate-300 focus:border-blue-500 focus:ring-blue-100"
                    }`}
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select
                        ...
                        disabled={isSubmitting}
                        {...register("status")}
                        className={`mt-2 block w-full rounded-lg border bg-white px-4 py-2.5 text-sm text-slate-900 outline-none transition focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-100 ${
                            errors.status
                                ? "border-red-300 focus:border-red-500 focus:ring-red-100"
                                : "border-slate-300 focus:border-blue-500 focus:ring-blue-100"
                        }`}
